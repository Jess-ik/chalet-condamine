					...
					{slice.items.map((item, index) => (
						<div key={index} className="px-4 cursor-pointer">
							<Button
								...
								<PrismicNextImage field={item.image} sizes="33vw" className="h-[450px] w-[600px] object-cover" imgixParams={{ auto: "format" }}/>
							</Button>
						</div>
					))}
				</Slider>
				...
				<ModalContent>
					{(onClose) => (
						<>
							...
							<ModalBody>
								<PrismicNextImage field={slice.items[selectedImageIndex].image} sizes="33vw" className="h-[50vh] object-contain" imgixParams={{  auto: "format" }} />
							</ModalBody>
